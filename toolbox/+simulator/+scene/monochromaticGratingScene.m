function theScene = monochromaticGratingScene(stimParams)
    ...
    if (~isempty(stimParams.sceneRadianceScalingFactor))
        gratingSpdRadianceProfile = gratingSpdRadianceProfile * stimParams.sceneRadianceScalingFactor;
    end
