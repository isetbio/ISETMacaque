function [sceneRadianceScalingFactor, computedROIenergyMicroWatts] = radianceScalingFactor(theBackgroundOI, calibrationROI)
    
    fprintf('Computing sceneRadianceScaling Factor\n');
    ...
    sceneRadianceScalingFactor = calibrationROI.energyMicroWatts / computedROIenergyMicroWatts;
end
