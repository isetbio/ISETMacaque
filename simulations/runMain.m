...
%         
    ...
    residualDefocusDioptersForDerivingModel = simulator.animalInfo.optimalResidualDefocusForSingleConeCenterRFmodel(...
    ...
    operationOptions.syntheticRGCmodelParams = struct(...
        'opticsParams', struct(...
            ...
            'residualDefocusDiopters', residualDefocusDioptersForDerivingModel), ...
